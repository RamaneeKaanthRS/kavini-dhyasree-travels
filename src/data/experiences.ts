...
export const EXPERIENCES_DATA: YercaudExperience[] = [
  {
    ...
    startingPriceNote: 'Starting from ₹4,499 / vehicle',
  ...
  },
  {
    ...
    startingPriceNote: 'Starting from ₹2,499 / trip',
    estateChargeNote: 'Attraction located on exclusive private estate. Certain private estate attractions may have approx. ₹999 additional estate permit fee.',
  ...
  },
  {
    ...
    startingPriceNote: 'Starting from ₹2,999 / trip',
    estateChargeNote: 'Located within private territory. Additional private estate entry of approx. ₹999 may apply per vehicle/group.',
  ...
  },
  {
    ...
    startingPriceNote: 'Starting from ₹1,999 / day',
